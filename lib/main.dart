...
class _PanCardFormScreenState extends State<PanCardFormScreen> {
  ...
  void _submitForm() {
    ...
    globalPanRequests.add({
      ...
      'aadhar': 'Uploaded & Verified',
      'voter': 'Uploaded & Verified',
      'status': 'Pending',
      'pdfUploaded': false,
    });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            CheckboxListTile(
              title: const Text('आधार कार्ड संलग्न करें (Uploaded)'),
              value: _aadharDone,
              onChanged: (val) {
                setState(() {
            ...
            CheckboxListTile(
              title: const Text('वोटर आईडी संलग्न करें (Uploaded)'),
              value: _voterDone,
              onChanged: (val) {
                setState(() {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Divider(),
                        Row(
                          mainAxisAlignment: MainizedBox == null ? MainAxisAlignment.end : MainAxisAlignment.end,
                          children: [
                            if (!isAccepted)
                              ElevatedButton.icon(
                                onPressed: () {
